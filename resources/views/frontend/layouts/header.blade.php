    ...
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="header container">
            <div class="header-logo">
                <a href="/">
                    <img loading="lazy" class="navbar-brand; header" src="{{ setting('fullImage', '/frontend/images/logo.svg') }}" alt={{ setting('site_title') }}>
                </a>
            </div>
            ...
            <div class="header-icons">
                <a class="nav-link" aria-label="Search" id="header-search" href="#">
                ...
                @auth
                    <div class=" dropdown" aria-label="User"
