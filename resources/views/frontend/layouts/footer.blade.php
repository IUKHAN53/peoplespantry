                            ...
                            <div class="last-list">
                                ...
                                <div class="list">
                                    <ul class="social-icons">
                                        <li><a class="instagram" target="_blank" href="{{ setting('instagram_url') }}"><i class="fab fa-instagram"></i> <span class="d-none">1</span></a></li>
                                        <li><a class="facebook" target="_blank" href="{{ setting('facebook_url') }}"><i class="fab fa-facebook"></i> <span class="d-none">1</span></a></li>
                                        <li><a class="twitter" target="_blank" href="{{ setting('twitter_url') }}"><i class="fab fa-twitter"></i> <span class="d-none">1</span></a></li>
                                    </ul>
                                </div>
                            </div>
