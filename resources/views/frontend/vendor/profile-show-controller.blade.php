    ...
    <div class="vendor-profile-main">
        <section>
            <div class="whats-new-banner"
                 style="background-image: url('{{ !empty($vendor->getFirstMediaUrl('banner')) ? $vendor->getFirstMediaUrl('banner') : getDummyImage() }}'), linear-gradient(rgba(0,0,0,0.15),rgba(0,0,0,0.15));">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="vendor-profile">
                            <div class="vendor-profile-img">
                                <img
                                    src="{{ !empty($vendor->getFirstMediaUrl('avatar')) ? $vendor->getFirstMediaUrl('avatar') : getDummyImage() }}"
                                    alt="">
                            </div>
                        ...
                        <div class="product-listing-search-main div-flex">
                            ...
                            <div class="input-group">
                                <input class="form-control" type="text" aria-labelledby="look" id="look"
                                       placeholder="{{ trans('product.product-search-button-placeholder') }}"
                                       wire:model.defer="search">
                                <button class="btn btn-outline-secondary" type="submit" wire:click="getProducts">
                                    <span>
                                        <svg style="display: inline-block;" width="23" height="23" viewBox="0 0 23 23"
                            ...
                            @forelse ($products as $product)
                                <div class="new-near-you-block">
                                    ...
                                    <div class="product-card-text">
                                        ...
                                        @else
                                            <livewire:frontend.shared.add-to-cart-button :product="$product"
                                                                                         :wire:key="$product->id"/>
                                        @endif
                                    </div>
                                </div>
