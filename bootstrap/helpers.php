...
if (!function_exists('vite')) {
    function vite($resource, $buildDirectory = 'assets')
    {
...
if (!function_exists('viteCssPath')) {
    function viteCssPath(string $resource, $buildDirectory = 'assets')
    {
...
if (!function_exists('viteJsPath')) {
    function viteJsPath(string $resource, $buildDirectory = 'assets')
    {
